                                    ...
                                    this.state.res[category].map((obj, item_ind) => 
                                        <Card className="search-screen-results-category-list-item" key={item_ind}>
                                            ...
                                            <Card.Body className="search-screen-results-category-list-item-body">
                                                ...
                                                <div className="search-screen-results-category-list-item-body-creator ellipsis-multi-line-overflow body-text color-jet">{obj.type === "session" ? obj.hostName : obj.type === "collection" ? obj.ownerName : obj.type === "song" ? obj.creator : ""}</div>
                                                {obj.type === "user" && obj.live === true ? 
