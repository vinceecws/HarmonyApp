                ...
                <Row id="mid-container" style={{marginLeft:'0px'}}>
                    ...
                    <Col id="screen-container">
                        <Switch>
                            ...
                            <Route path='/main/profile/:userId' render={(props) => <ProfileScreen {...props} auth={this.props.auth} key={props.match.params.userId} axiosWrapper = {this.props.axiosWrapper}/>} />
                            ...
                            <Route path='/main/settings/:userId' render={(props) => <SettingsScreen {...props} auth={this.props.auth} user={this.props.user} axiosWrapper = {this.props.axiosWrapper}/>} />
