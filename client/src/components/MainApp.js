                ...
                <Row id="mid-container" style={{marginLeft:'0px'}}>
                    ...
                    <Col id="screen-container">
                        <Switch>
                            ...
                            <Route path='/main/collection/:collectionId' render={(props) => <CollectionScreen {...props} auth={this.props.auth} user={this.props.user} axiosWrapper = {this.props.axiosWrapper} queue = {this.queue} dataAPI = {this.dataAPI} playVideo = {this.playVideo} />} />
